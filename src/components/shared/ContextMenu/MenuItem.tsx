  ...
  return (
    ...
    >
      <button
        onClick={handleClick}
        disabled={disabled}
        className="w-full text-left px-3 py-1.5 text-sm text-slate-700 rounded-md hover:bg-primary/10 hover:text-primary flex justify-between items-center disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {label}
